...
df_Limerick.Peoples.Park <- data.frame(NO2_clone$Date,NO2_clone$Limerick.Peoples.Park,NO_clone$Limerick.Peoples.Park,O3_clone$Limerick.Peoples.Park,PM2_5_clone$Limerick.Peoples.Park,PM10_clone$Limerick.Peoples.Park)
df_Rathmines <- data.frame(NO2_clone$Date,NO2_clone$Rathmines,NO_clone$Rathmines,O3_clone$Rathmines,PM2_5_clone$Rathmines,PM10_clone$Rathmines)
df_Waterford <- data.frame(NO2_clone$Date,NO2_clone$Waterford,NO_clone$Waterford,O3_clone$Waterford,PM2_5_clone$Waterford,PM10_clone$Waterford)
...
#################################################
# Original data replaced with preprocessed data
# No need to perform below operations
#################################################
...
#################################################
# Original data replaced with preprocessed data
# No need to perform above operations
#################################################
