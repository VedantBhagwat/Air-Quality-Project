...
md_plot_NO2 + 
  ...
  ggtitle("Missing data of NO2 in 2018, 2019, and 2020")
...
md_plot_NO + 
  ...
  theme_minimal() +
  theme(axis.text.x=element_text(angle = 45, hjust = 1))+
  ggtitle("Missing data of NO in 2018, 2019, and 2020")
...
md_plot_O3 + 
  ...
  theme_minimal() +
  theme(axis.text.x=element_text(angle = 45, hjust = 1))+
  ggtitle("Missing data of O3 in 2018, 2019, and 2020")
...
md_plot_PM2_5 + 
  ...
  theme_minimal() +
  theme(axis.text.x=element_text(angle = 45, hjust = 1))+
  ggtitle("Missing data of PM2_5 in 2018, 2019, and 2020")
...
md_plot_PM10 + 
  ...
  theme_minimal() +
  theme(axis.text.x=element_text(angle = 45, hjust = 1))+
  ggtitle("Missing data of PM10 in 2018, 2019, and 2020")
